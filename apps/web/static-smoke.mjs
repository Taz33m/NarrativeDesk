...
assert.equal(evaluations.aggregate.case_count, 2);
...
assert.equal(evaluations.aggregate.source_cluster_count, 9);
assert.equal(evaluations.aggregate.source_duplicate_cluster_count, 4);
