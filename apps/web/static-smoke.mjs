...
assert.equal(cases.cases[0].bundle_integrity.readiness_status, 'synthetic_demo_fixture');
assert.equal(cases.cases[0].bundle_integrity.artifact_hashes_ok, null);
