...
assert.equal(evaluations.aggregate.blocked_future_source_count, 4);
assert.equal(evaluations.aggregate.source_cluster_count, 15);
assert.equal(evaluations.aggregate.source_duplicate_cluster_count, 6);
